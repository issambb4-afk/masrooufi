  ...
  Future<void> restoreBackup(File file) async {
    ...
    await database.transaction(() async {
      ...
      for (var r in backupData.recurringRules) {
        await recurringRepo.createRule(r);
      }
